...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://alpha.my.usa.gov/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://alpha.my.usa.gov/oauth/authorize';
  options.callbackURL = options.callbackURL || 'http://localhost:3000/auth/myusa/callback';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'myusa';
  this._profileURL = options.profileURL || 'https://alpha.my.usa.gov/api/profile';
}
